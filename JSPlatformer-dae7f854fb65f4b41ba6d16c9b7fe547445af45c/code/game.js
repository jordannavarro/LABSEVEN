...
function Coin2(pos) {
	this.basePos = this.pos = pos.plus(new Vector(0.3,0.5));
	this.size = new Vector(1.0, 0.8);
...
var wobbleSpeed2 = 5;
var wobbleDist2 = 0.2;
Coin2.prototype.act = function(step) {
...
//describes what happens when the coins are touched
